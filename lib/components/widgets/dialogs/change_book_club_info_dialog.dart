...
class ChangeClubInfoDialog extends Dialog {
  ...
  Future<void> addClub(BuildContext context) async {
    ...
    final jsonString = json.encode({
      ...
      if (_coverImageUrl
          .trim()
          .isNotEmpty) "coverImageUrl": _coverImageUrl,
      //"bannerImageUrl": ,
      "isPublic": isPublic,
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        InputTextField(
                          ...
                          defaultText: isSystemImage(_coverImageUrl) ? null : _coverImageUrl,
                          onChanged: (String value) {
                        ...
                        InputTextField(
                          ...
                          height: 0.1,
                          hintText: 'Прямая ссылка на изображение',
                          defaultText: isSystemImage(_bannerImageUrl) ? null : _bannerImageUrl,
                          onChanged: (String value) {
